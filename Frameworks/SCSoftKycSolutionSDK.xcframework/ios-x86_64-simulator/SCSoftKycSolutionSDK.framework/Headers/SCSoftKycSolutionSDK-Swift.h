...
#ifndef SCSOFTKYCSOLUTIONSDK_SWIFT_H
#define SCSOFTKYCSOLUTIONSDK_SWIFT_H
...
#import <SCSoftKycSolutionSDK/SCSoftKycSolutionSDK.h>
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SCSoftKycSolutionSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP20SCSoftKycSolutionSDK17JMCallKitListener_")
...
SWIFT_CLASS("_TtC20SCSoftKycSolutionSDK14JMCallKitProxy")
...
SWIFT_CLASS("_TtC20SCSoftKycSolutionSDK14PassportReader") SWIFT_AVAILABILITY(ios,introduced=13)
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC20SCSoftKycSolutionSDK24SCSoftKycIdBackPhotoView")
@interface SCSoftKycIdBackPhotoView : UIView
...
@interface SCSoftKycIdBackPhotoView (SWIFT_EXTENSION(SCSoftKycSolutionSDK)) <AVCaptureVideoDataOutputSampleBufferDelegate>
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC20SCSoftKycSolutionSDK25SCSoftKycIdFrontPhotoView")
@interface SCSoftKycIdFrontPhotoView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)layoutSubviews;
@end
...
@interface SCSoftKycIdFrontPhotoView (SWIFT_EXTENSION(SCSoftKycSolutionSDK)) <AVCaptureVideoDataOutputSampleBufferDelegate>
- (void)captureOutput:(AVCaptureOutput * _Nonnull)output didOutputSampleBuffer:(CMSampleBufferRef _Nonnull)sampleBuffer fromConnection:(AVCaptureConnection * _Nonnull)connection;
@end
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC20SCSoftKycSolutionSDK18SCSoftKycJitsiView")
@interface SCSoftKycJitsiView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface SCSoftKycJitsiView (SWIFT_EXTENSION(SCSoftKycSolutionSDK)) <JitsiMeetViewDelegate>
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC20SCSoftKycSolutionSDK16SCSoftKycNfcView") SWIFT_AVAILABILITY(ios,introduced=13)
@interface SCSoftKycNfcView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)nfcReadInput;
@end
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC20SCSoftKycSolutionSDK19SCSoftKycSelfieView")
@interface SCSoftKycSelfieView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)layoutSubviews;
@end
...
@interface SCSoftKycSelfieView (SWIFT_EXTENSION(SCSoftKycSolutionSDK)) <AVCaptureVideoDataOutputSampleBufferDelegate>
- (void)captureOutput:(AVCaptureOutput * _Nonnull)output didOutputSampleBuffer:(CMSampleBufferRef _Nonnull)sampleBuffer fromConnection:(AVCaptureConnection * _Nonnull)connection;
@end
